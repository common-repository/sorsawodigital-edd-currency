<?php
/*
Plugin Name: Custom EDD Currency
...
class Sorsawo_Digital_EDD_Currency {
    ...
    public function register_admin_menu() {
        $this->admin_page = add_submenu_page( 'edit.php?post_type=download', __( 'Custom Currencies', 'sorsawodigital-edd-currency' ), __( 'Manage Currencies', 'sorsawodigital-edd-currency' ), 'manage_shop_settings', 'sorsawodigital-edd-currency', array( $this, 'render_pages' ) );
